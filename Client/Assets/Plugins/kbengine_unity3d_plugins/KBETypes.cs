...
namespace KBEngine
{
	...
	{
		public UInt64 space_key = 0;
		public Byte player_count = 0;
		public SByte space_state = 0;
		public Int32 space_creater = 0;

	}

	public class SPACE_LIST
	{
		public List<SPACE_INFO> values = new List<SPACE_INFO>();
