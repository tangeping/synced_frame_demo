...
namespace KBEngine
{
	...
	public class DATATYPE_SPACE_INFO : DATATYPE_BASE
	{
	...
	public class DATATYPE_SPACE_LIST : DATATYPE_BASE
	{
		private DATATYPE__SPACE_LIST_values_ArrayType_ChildArray values_DataType = new DATATYPE__SPACE_LIST_values_ArrayType_ChildArray();

		public class DATATYPE__SPACE_LIST_values_ArrayType_ChildArray : DATATYPE_BASE
		{
			private DATATYPE_SPACE_INFO itemType = new DATATYPE_SPACE_INFO();

			public List<SPACE_INFO> createFromStreamEx(MemoryStream stream)
			{
				UInt32 size = stream.readUint32();
				List<SPACE_INFO> datas = new List<SPACE_INFO>();
			...
			public void addToStreamEx(Bundle stream, List<SPACE_INFO> v)
			{
				stream.writeUint32((UInt32)v.Count);
				for(int i=0; i<v.Count; ++i)
				{
