...
namespace KBEngine
{
	public abstract class AbstractLockstep
	{
        ...
        */
		internal Dictionary<byte, FPPlayer> players;

		internal List<FPPlayer> activePlayers;
		...
		internal FPPlayer localPlayer; // 本地玩家

		protected FrameSyncUpdateCallback StepUpdate;

		private FrameSyncInputCallback GetLocalData; // 获取本地数据

		internal FrameSyncInputDataProvider InputDataProvider;

		private FrameSyncEventCallback OnGameStarted;

		private FrameSyncEventCallback OnGamePaused;

		private FrameSyncEventCallback OnGameUnPaused;

		private FrameSyncEventCallback OnGameEnded;

		private FrameSyncPlayerDisconnectionCallback OnPlayerDisconnection;

		public FrameSyncIsReady GameIsReady;
        ...
        #region 属性
        public List<FPPlayer> ActivePlayers
		{
			get
			{
		...
		public IDictionary<byte, FPPlayer> Players
		{
			get
			{
				return this.players;
		...
		private bool CheckDrop(FPPlayer p)
		{
