 ...
 **/
        [SerializeField]
        internal Dictionary<byte, string> stringTable;

        /**
         * @brief Contains data about byte values.
         **/
        [SerializeField]
        internal Dictionary<byte, byte> byteTable;

        /**
         * @brief Contains data about int values.
         **/
        [SerializeField]
        internal Dictionary<byte, int> intTable;

        /**
         * @brief Contains data about FP values.
         **/
        [SerializeField]
        internal Dictionary<byte, FP> fpTable;

        /**
         * @brief Contains data about byte[] values.
         **/
        [SerializeField]
        internal Dictionary<byte, byte[]> byteArrayTable;

        /**
         * @brief Contains data about TSVector values.
         **/
        [SerializeField]
        internal Dictionary<byte, TSVector> tsVectorTable;

        /**
         * @brief Contains data about TSVector values.
         **/
        [SerializeField]
        internal Dictionary<byte, TSVector2> tsVectorTable2;

        internal FixedPointStream stream;
        private enum Types : byte { Byte = 0, String = 1, Integer = 2, FP = 3, TSVector = 4, TSVector2 = 5, ByteArray = 6 };
        public override void CleanUp()
        {
            this.stringTable = new Dictionary<byte, string>();
            this.byteTable = new Dictionary<byte, byte>();
            this.intTable = new Dictionary<byte, int>();
            this.fpTable = new Dictionary<byte, FP>();
            this.byteArrayTable = new Dictionary<byte, byte[]>();
            this.tsVectorTable = new Dictionary<byte, TSVector>();
            this.tsVectorTable2 = new Dictionary<byte, TSVector2>();
        }
